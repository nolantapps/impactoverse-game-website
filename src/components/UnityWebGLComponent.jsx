...
const UnityWebGLComponent = () => {
  ...
  const [checkboxPopup, setCheckBoxPopUp] = useState(true);
  ...
  return (
    ...
    >
      <ScreenTimeTracker gameId="67aa92b05a9129b7c865b8b9" />
      
      <iframe
        title="Unity WebGL Game"
        src={`/Berthe's Brush at Bougival 1/index.html?userID=${DataStore.getUserId()}&userName=${DataStore.getUsername()}`}
        style={{
          width: '90vw',
          height: '100vh',
          border: 'none',
