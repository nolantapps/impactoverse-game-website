  ...
  return (
    <nav className={`${navClasses} p-4 relative transition-colors duration-300`}>
      <div className="flex justify-between items-center max-w-7xl mx-auto relative">
        ...
        <div className="hidden lg:flex absolute left-1/2 transform -translate-x-1/2 space-x-8 font-bold top-14"> 
          <Link to="/">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          {isAuthenticated ? (
            <div className="relative">
              ...
              >
                <span>Hi </span>
                <span>{datastore.getDisplayName()} </span>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 011.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </button>
...
<svg
    ...
    <path
      ...
      <div className="hidden lg:flex relative w-full mt-6 items-center justify-center">
        <div className={`h-[1px] ${isDarkMode ? 'bg-white' : 'bg-gray-800'} w-[43%]`}></div>
