...
const Navbar2 = () => {
  ...
  const navClasses = isDarkMode ? 'bg-[#1E034B] backdrop-blur-md' : 'bg-[#f4f5fb] backdrop-blur-md shadow-md';
  ...
  return (
    <nav className={`${navClasses} p-0 relative transition-colors duration-300`}>
                  ...
                  {isMenuOpen && (
                    <div className={`absolute right-0 mt-2 py-2 w-48 rounded-md shadow-lg z-20 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
                      <button
                        ...
                        className="block px-4 py-2 text-sm w-full hover:bg-gray-200 font-calSans font-bold"
                      >
                      ...
                      <button
                        ...
                        className="block px-4 py-2 text-sm w-full text-left hover:bg-gray-200 font-calSans font-bold"
                      >
                        {t('navbar.dashboard')}
                      </button>
                      <button
