...
const AboutUs = () => {
  ...
  return (
    <section className={`${isDarkMode ? 'bg-[#1E034B] text-white' : 'bg-[#C7DDEA] text-gray-900'} py-20`}>
      <div className={`max-w-7xl  mx-auto px-6 md:px-12 lg:px-20 space-y-32`}>

        {/* Hero Section */}
        <div className={`relative rounded-xl ${isDarkMode ? 'bg-dark-gradient' : 'bg-light-gradient'} flex flex-col md:flex-row items-center md:items-start pt-16 px-6 md:px-16 lg:px-32 gap-10`}>
          {/* Text Content */}
